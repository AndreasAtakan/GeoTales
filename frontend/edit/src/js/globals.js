...
const _BASEMAPS = [
	...
	{ int: true,	name: "USGS.USTopo",					zoom: [0, 16],	preview: "https://basemap.nationalmap.gov/arcgis/rest/services/USGSTopo/MapServer/tile/5/10/15" },
	{ int: true,	name: "USGS.USImagery",					zoom: [0, 16],	preview: "https://basemap.nationalmap.gov/arcgis/rest/services/USGSImageryOnly/MapServer/tile/5/10/15" },
	{ int: true,	name: "USGS.USImageryTopo",				zoom: [0, 16],	preview: "https://basemap.nationalmap.gov/arcgis/rest/services/USGSImageryTopo/MapServer/tile/5/10/15" },
