		...
		<main role="main">
			<div class="container" id="main">
				...
				<div class="row mx-auto" style="max-width: 350px;">
					<div class="col">
						<div role="alert" class="alert alert-success" id="confirm_success">
							E-mail has been confirmed
						</div>

						<div role="alert" class="alert alert-danger" id="confirm_failed">
							E-mail has been confirmed
						</div>

						<p class="text-muted my-3">
							<strong><a href="signin.php?return_url=<?php echo $loc; ?>">sign in</a></strong>
						</p>
					</div>
				</div>
			...
			window.onload = function(ev) {
				...
				$.ajax({
					...
					error: function(xhr, status, error) {
						...
						$("#confirm_failed").css("display", "block");
