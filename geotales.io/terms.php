				...
				<div class="row">
					<div class="col">
						...
						<ul>
							...
							<li>
								<p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Nordfjord EDB AS, Fjordvegen 3357, 6793 Innvik.</p>
							</li>
							<li>
							...
							<li>
								<p><strong>Website</strong> refers to GeoTales, accessible from <a href="https://geotales.io" rel="external nofollow noopener" target="_blank">https://geotales.io</a></p>
							</li>
							<li>
						...
						<p>You can contact our copyright agent via email at <a href="mailto:<?php echo $CONFIG['email']; ?>"><?php echo $CONFIG['email']; ?></a>
						...
						<ul>
							<li>By email: <a href="mailto:<?php echo $CONFIG['email']; ?>"><?php echo $CONFIG['email']; ?></a></li>
						</ul>
					</div>
				</div>
